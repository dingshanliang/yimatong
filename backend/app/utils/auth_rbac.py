...
WEB_ROLE_PERMISSIONS: dict[str, list[str]] = {
    ...
    "viewer": [],
    # Channel portal identities are intentionally subject-bound. They receive
    # no generic RBAC permissions; their dedicated endpoints validate the
    # durable JWT role and AccountChannelScope instead.
    "distributor": [],
    "store_guide": [],
    "platform_admin": [
        "platform:admin",
