...
def test_only_expected_business_mutations_use_function_scoped_get_db():
    ...
    # 白名单收录当前实际使用 function scope 的路由清单。
    # 注意：其中 GET 只读路由使用 function scope 属现状，收敛待专项。
    assert registered_scopes == {
        ...
        ("DELETE", "/api/v1/channels/account-scopes/{scope_id}", "function"),
        ("DELETE", "/api/v1/channels/stores/{store_id}", "function"),
        ("DELETE", "/api/v1/commerce/connections/{connection_id}", "function"),
        ("DELETE", "/api/v1/commerce/connections/{connection_id}/credentials/{credential_id}", "function"),
        ...
        ("DELETE", "/api/v1/risk-rules/{rule_id}", "function"),
        ("DELETE", "/api/v1/risk-rules/{rule_id}/campaigns/{campaign_id}", "function"),
        ("DELETE", "/api/v1/skus/{sku_id}", "function"),
        ("DELETE", "/api/v1/webhooks/api-keys/{key_id}", "function"),
        ("DELETE", "/api/v1/webhooks/endpoints/{endpoint_id}", "function"),
        ("GET", "/api/v1/benefit-claims/{claim_id}/status", "function"),
        ("GET", "/api/v1/channel-analytics/conversion-comparison", "function"),
        ("GET", "/api/v1/channel-analytics/health-scores", "function"),
        ("GET", "/api/v1/channel-analytics/scan-by-channel", "function"),
        ("GET", "/api/v1/channels/account-scopes", "function"),
        ("GET", "/api/v1/channels/code-allocations", "function"),
        ("GET", "/api/v1/channels/code-items/{public_id}/store", "function"),
        ("GET", "/api/v1/channels/distributors", "function"),
        ("GET", "/api/v1/channels/diversion-clues", "function"),
        ("GET", "/api/v1/channels/overview", "function"),
        ("GET", "/api/v1/channels/portal/distributor/diversion-alerts", "function"),
        ("GET", "/api/v1/channels/portal/distributor/summary", "function"),
        ("GET", "/api/v1/channels/portal/store/summary", "function"),
        ("GET", "/api/v1/channels/regions", "function"),
        ("GET", "/api/v1/channels/stores", "function"),
        ("GET", "/api/v1/commerce/connections", "function"),
        ("GET", "/api/v1/commerce/connections/{connection_id}/reconciliation", "function"),
        ("GET", "/api/v1/commerce/orders", "function"),
        ("GET", "/api/v1/commerce/repurchase/metrics", "function"),
        ("GET", "/api/v1/risk-dashboard/diversion-clues/{clue_id}/investigation", "function"),
        ...
        ("PATCH", "/api/v1/channels/distributors/{distributor_id}", "function"),
        ("PATCH", "/api/v1/channels/regions/{region_id}", "function"),
        ("PATCH", "/api/v1/channels/stores/{store_id}", "function"),
        ...
        ("PATCH", "/api/v1/members/repurchase-workbench/work-items/{item_id}", "function"),
        ("PATCH", "/api/v1/members/repurchase-workbench/work-items/{item_id}/assignment", "function"),
        ("PATCH", "/api/v1/page-templates/{template_id}", "function"),
        ("PATCH", "/api/v1/page-versions/{version_id}", "function"),
        ("PATCH", "/api/v1/privacy/rights-requests/{request_id}", "function"),
        ...
        ("PATCH", "/api/v1/retrospectives/{retro_id}", "function"),
        ("PATCH", "/api/v1/risk-rules/{rule_id}", "function"),
        ("PATCH", "/api/v1/risk/rules/{rule_id}", "function"),
        ("PATCH", "/api/v1/skus/{sku_id}", "function"),
        ("PATCH", "/api/v1/takeovers/{project_id}", "function"),
        ("PATCH", "/api/v1/webhooks/endpoints/{endpoint_id}", "function"),
        ("PATCH", "/open/v1/products/{product_id}", "function"),
        ("PATCH", "/open/v1/skus/{sku_id}", "function"),
        ("POST", "/api/v1/analytics/exports", "function"),
        ...
        ("POST", "/api/v1/channels/account-scopes", "function"),
        ("POST", "/api/v1/channels/code-allocations", "function"),
        ("POST", "/api/v1/channels/code-allocations/{allocation_id}/archive", "function"),
        ("POST", "/api/v1/channels/code-allocations/{allocation_id}/reassign", "function"),
        ("POST", "/api/v1/channels/code-batches/{batch_id}/assign", "function"),
        ("POST", "/api/v1/channels/distributors", "function"),
        ("POST", "/api/v1/channels/regions", "function"),
        ("POST", "/api/v1/channels/stores", "function"),
        ...
        ("POST", "/api/v1/commerce/connections", "function"),
        ("POST", "/api/v1/commerce/connections/{connection_id}/credentials/rotate", "function"),
        ("POST", "/api/v1/commerce/product-mappings", "function"),
        ...
        ("POST", "/api/v1/launch-releases", "function"),
        ("POST", "/api/v1/launch-releases/{release_id}/confirm", "function"),
        ("POST", "/api/v1/launch-releases/{release_id}/confirm-and-launch", "function"),
        ("POST", "/api/v1/launch-releases/{release_id}/launch", "function"),
        ("POST", "/api/v1/launch-releases/{release_id}/resume", "function"),
        ("POST", "/api/v1/launch-releases/{release_id}/suspend", "function"),
        ("POST", "/api/v1/member-notifications/marketing-events", "function"),
        ("POST", "/api/v1/members/consumers", "function"),
        ("POST", "/api/v1/members/repurchase-workbench/work-items", "function"),
        ("POST", "/api/v1/members/repurchase-workbench/work-items/{item_id}/actions", "function"),
        ("POST", "/api/v1/ops/launch-releases", "function"),
        ("POST", "/api/v1/ops/launch-releases/{release_id}/publish", "function"),
        ("POST", "/api/v1/ops/launch-releases/{release_id}/request-confirmation", "function"),
        ...
        ("POST", "/api/v1/privacy/members/{consumer_id}/pii-reveal", "function"),
        ("POST", "/api/v1/privacy/sensitive-exports", "function"),
        ("POST", "/api/v1/privacy/sensitive-exports/{export_id}/approve", "function"),
        ("POST", "/api/v1/privacy/sensitive-exports/{export_id}/download", "function"),
        ("POST", "/api/v1/privacy/sensitive-exports/{export_id}/prepare", "function"),
        ...
        ("POST", "/api/v1/public/benefits/{benefit_id}/claim", "function"),
        ("POST", "/api/v1/repurchase-coupon-rules", "function"),
        ("POST", "/api/v1/repurchase-coupon-rules/{rule_version_id}/transition", "function"),
        ("POST", "/api/v1/repurchase-coupons/issue", "function"),
        ("POST", "/api/v1/repurchase-coupons/store/redeem", "function"),
        ("POST", "/api/v1/repurchase-coupons/{coupon_id}/commit", "function"),
        ("POST", "/api/v1/repurchase-coupons/{coupon_id}/release", "function"),
        ("POST", "/api/v1/repurchase-coupons/{coupon_id}/reserve", "function"),
        ("POST", "/api/v1/repurchase-coupons/{coupon_id}/reverse", "function"),
        ("POST", "/api/v1/repurchase-coupons/{coupon_id}/revoke", "function"),
        ...
        ("POST", "/api/v1/risk-dashboard/diversion-clues/{clue_id}/evidence", "function"),
        ("POST", "/api/v1/risk-dashboard/diversion-clues/{clue_id}/transition", "function"),
        ("POST", "/api/v1/risk-dashboard/export", "function"),
        ("POST", "/api/v1/risk-notifications/mark-all-read", "function"),
        ("POST", "/api/v1/risk-notifications/{notification_id}/read", "function"),
        ("POST", "/api/v1/risk-rules", "function"),
        ("POST", "/api/v1/risk-rules/evaluate/scan", "function"),
        ("POST", "/api/v1/risk-rules/pauses/{pause_id}/resume", "function"),
        ("POST", "/api/v1/risk-rules/{rule_id}/campaigns/{campaign_id}", "function"),
        ("POST", "/api/v1/risk/rules", "function"),
        ...
        ("POST", "/api/v1/takeovers/{project_id}/imports/{job_id}/errors.csv", "function"),
        ...
        ("POST", "/api/v1/webhooks/endpoints", "function"),
        ...
        ("PUT", "/api/v1/channels/distributors/{distributor_id}", "function"),
        ("PUT", "/api/v1/channels/regions/{region_id}", "function"),
        ("PUT", "/api/v1/channels/stores/{store_id}", "function"),
    }
